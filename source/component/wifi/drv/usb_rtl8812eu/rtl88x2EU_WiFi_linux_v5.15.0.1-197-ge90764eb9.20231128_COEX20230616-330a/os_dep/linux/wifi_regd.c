...
static void rtw_chset_apply_wiphy_chans(struct rtw_chset *chset)
{
	RT_CHANNEL_INFO *chinfo;
	u8 i;
	u8 flags;
...
void rtw_chset_apply_from_os(struct rtw_chset *chset)
{
	rtw_chset_apply_wiphy_chans(chset);
}

...
__odm_func__
void phydm_set_csi_mask_8822e(struct dm_struct *dm, u32 tone_idx, u8 csi_weighting_val)
{
	...
	if (tone_idx & 0x1)
		odm_set_bb_reg(dm, R_0x1d94, 0xf0, csi_weighting_val);
	else
		odm_set_bb_reg(dm, R_0x1d94, 0xf, csi_weighting_val);
...
__odm_func__
void phydm_clean_specific_csi_mask_8822e(struct dm_struct *dm)
{
	u8 i = 0;
	u8 tone_idx[8] = {7, 8, 16, 55, 56, 103, 104, 112};
	...
	for (i = 0; i < 8; i++) {
		odm_set_bb_reg(dm, R_0x1d94, MASKBYTE2, tone_idx[i]);
		odm_set_bb_reg(dm, R_0x1d94, MASKBYTE0, 0x0);
	}
...
void phydm_spur_eliminate_8822e(struct dm_struct *dm, u8 central_ch)
{
	...
	if (central_ch == 153 && (*dm->band_width == CHANNEL_WIDTH_20)) {
		phydm_clean_specific_csi_mask_8822e(dm);
		phydm_set_manual_nbi_8822e(dm, true, 112); /*5760 MHz*/
		phydm_set_nbi_wa_para_8822e(dm, true, *dm->band_width);
		phydm_set_csi_mask_8822e(dm, 111, 0xa);
		phydm_set_csi_mask_8822e(dm, 112, 0xa);
		phydm_set_csi_mask_8822e(dm, 113, 0xa);
		...
		phydm_set_nbi_wa_para_8822e(dm, true, *dm->band_width);
		phydm_set_csi_mask_8822e(dm, 15, 0xa);
		phydm_set_csi_mask_8822e(dm, 16, 0xa);
		phydm_set_csi_mask_8822e(dm, 17, 0xa);
		...
		phydm_set_nbi_wa_para_8822e(dm, true, *dm->band_width);
		phydm_set_csi_mask_8822e(dm, 207, 0xa);
		phydm_set_csi_mask_8822e(dm, 208, 0xa);
		phydm_set_csi_mask_8822e(dm, 209, 0xa);
		...
		phydm_set_csi_mask_8822e(dm, 32, 0xc);
		odm_set_bb_reg(dm, R_0xc24, MASKLWORD, 0x00ff); /*packet detection set to default value*/
	} else if (central_ch == 102 && (*dm->band_width == CHANNEL_WIDTH_40)) {
		phydm_clean_specific_csi_mask_8822e(dm);
		...
		phydm_set_manual_nbi_8822e(dm, false, 0); /*5280 MHz*/
		phydm_set_nbi_wa_para_8822e(dm, false, *dm->band_width);
		phydm_set_csi_mask_8822e(dm, 224, 0xa);
		odm_set_bb_reg(dm, R_0xc24, MASKLWORD, 0x00ff); /*packet detection set to default value*/
	} else if (central_ch == 106 && (*dm->band_width == CHANNEL_WIDTH_80)) {
		phydm_clean_specific_csi_mask_8822e(dm);
		phydm_set_manual_nbi_8822e(dm, false, 0); /*5280 MHz*/
		phydm_set_nbi_wa_para_8822e(dm, false, *dm->band_width);
		phydm_set_csi_mask_8822e(dm, 224, 0xa);
...
void phydm_tx_triangular_shap_cfg_8822e(struct dm_struct *dm, boolean is_2g_ch)
{
	...
	if (is_2g_ch) {
		odm_set_bb_reg(dm, R_0xa74, 0x3ff, 0x15);
		odm_set_bb_reg(dm, R_0xa74, 0xffc00, 0x13);
		...
		odm_set_bb_reg(dm, R_0xa74, 0x3ff, 0x3f);
		odm_set_bb_reg(dm, R_0xa74, 0xffc00, 0x3f);
		odm_set_bb_reg(dm, R_0x80c, 0xf, 0x8);

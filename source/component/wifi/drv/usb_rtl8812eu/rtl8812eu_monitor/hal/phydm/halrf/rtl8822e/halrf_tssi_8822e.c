...
void _backup_bb_registers_8822e(
	void *dm_void,
	u32 *reg,
	u32 *reg_backup,
	u32 reg_num)
...
void _reload_bb_registers_8822e(
	void *dm_void,
	u32 *reg,
	u32 *reg_backup,
	u32 reg_num)
...
u8 _halrf_driver_rate_to_tssi_rate_8822e(
...
u8 _halrf_tssi_rate_to_driver_rate_8822e(
	void *dm_void, u8 rate)
{
	u8 driver_rate = 0;
...
void _halrf_calculate_txagc_codeword_8822e(
...
u32 _halrf_get_efuse_tssi_offset_8822e(
...
s8 _halrf_get_kfree_tssi_offset_8822e(
	void *dm_void)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	struct _hal_rf_ *rf = &dm->rf_table;
...
void _halrf_calculate_set_thermal_codeword_8822e(
	void *dm_void)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
...
void _halrf_set_txagc_codeword_8822e(
...
void _halrf_set_efuse_kfree_offset_8822e(
	void *dm_void)
{
#if 0
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	...
	/*path s0*/
	/*2G CCK*/
	offset = (_halrf_get_efuse_tssi_offset_8822e(dm, 3) +
	 	_halrf_get_kfree_tssi_offset_8822e(dm)) & 0xff;
	...
	/*2G & 5G OFDM*/
	offset = (_halrf_get_efuse_tssi_offset_8822e(dm, 19) +
	 	_halrf_get_kfree_tssi_offset_8822e(dm)) & 0xff;
	...
	void *dm_void)
{
	...
	_halrf_calculate_set_thermal_codeword_8822e(dm);
	halrf_calculate_tssi_codeword_8822e(dm);
	/*_halrf_calculate_txagc_codeword_8822e(dm, tssi->tssi_codeword, tssi->txagc_codeword);*/
	/*_halrf_set_txagc_codeword_8822e(dm, tssi->txagc_codeword);*/
	halrf_set_tssi_codeword_8822e(dm, tssi->tssi_codeword);
	/*_halrf_set_efuse_kfree_offset_8822e(dm);*/
}

void _halrf_tssi_8822e(
	void *dm_void)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	struct _hal_rf_ *rf = &dm->rf_table;
...
void _halrf_thermal_init_8822e(
	void *dm_void)
{
#if 0
	struct dm_struct *dm = (struct dm_struct *)dm_void;
...
void halrf_calculate_tssi_codeword_8822e(
	void *dm_void)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	struct _hal_rf_ *rf = &dm->rf_table;
	...
	for (i = 0; i < TSSI_CODE_NUM; i++) {
		rate = _halrf_tssi_rate_to_driver_rate_8822e(dm, i);
...
void halrf_set_tssi_codeword_8822e(
	...
	void *dm_void)
{
	...
	_backup_bb_registers_8822e(dm, bb_reg, bb_reg_backup, backup_num);

	for (i = 0; i < MAX_PATH_NUM_8822E; i++) {
		odm_set_bb_reg(dm, addr_cck_d[i], addr_cck_d_bitmask[i], 0x0);
		odm_set_bb_reg(dm, addr_d[i], addr_d_bitmask[i], 0x0);
	}

	halrf_disable_tssi_8822e(dm);
	...
	_reload_bb_registers_8822e(dm, bb_reg, bb_reg_backup, backup_num);
	rf->is_tssi_in_progress = 0;
	/*odm_release_spin_lock(dm, RT_IQK_SPINLOCK);*/

}

void halrf_tssi_get_efuse_8822e(
	void *dm_void)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	struct _hal_rf_ *rf = &dm->rf_table;
	...
	void *dm_void, u8 path)
{
	...
	/*halrf_do_tssi_8822e(dm);*/
	rf->is_tssi_in_progress = 1;

	_halrf_tssi_8822e(dm);
...
void halrf_tssi_get_kfree_efuse_8822e(
	void *dm_void)
{
#if 0
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	...
	void *dm_void)
{
	...
	for (i = 0; i < MAX_PATH_NUM_8822E; i++) {
		...
		tssi_offest_de = (s8)_halrf_get_efuse_tssi_offset_8822e(dm, i);
...
void halrf_tssi_set_de_for_tx_verify_8822e(
	...
	void *dm_void)
{
	...
	halrf_tssi_set_de_8822e(dm);
	halrf_disable_tssi_8822e(dm);
	_halrf_tssi_init_8822e(dm);
	/*halrf_tssi_dck_8822e(dm);*/
	_halrf_tssi_8822e(dm);
...
u32 halrf_set_tssi_value_8822e(
	void *dm_void,
	u32 tssi_value)
{
#if 0
	...
	u8 tssi_rate = _halrf_driver_rate_to_tssi_rate_8822e(dm, tx_rate);
	u8 rate = phydm_get_tx_rate(dm);
	s8 efuse, kfree;
	...
	_halrf_calculate_txagc_codeword_8822e(dm, tssi_codeword_tmp, txagc_codeword_tmp);
	_halrf_set_txagc_codeword_8822e(dm, txagc_codeword_tmp);
	halrf_set_tssi_codeword_8822e(dm, tssi_codeword_tmp);

	kfree = _halrf_get_kfree_tssi_offset_8822e(dm);
...
void halrf_set_tssi_poewr_8822e(
	void *dm_void,
	s8 power)
{
	s32 tssi_codeword = 0;
...
void halrf_get_efuse_thermal_pwrtype_8822e(
	void *dm_void)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	struct dm_rf_calibration_struct *cali_info = &(dm->rf_calibrate_info);
...
u32 halrf_query_tssi_value_8822e(
	void *dm_void)
{
	s32 tssi_codeword = 0;
	...
	tssi_rate = _halrf_driver_rate_to_tssi_rate_8822e(dm, rate);
	/*tssi_codeword = tssi->tssi_codeword[tssi_rate];*/

#if 0
	if (rate == MGN_1M || rate == MGN_2M || rate == MGN_5_5M || rate == MGN_11M) {
		efuse = _halrf_get_efuse_tssi_offset_8822e(dm, 3);
		kfree = _halrf_get_kfree_tssi_offset_8822e(dm);
	} else {
		efuse = _halrf_get_efuse_tssi_offset_8822e(dm, 19);
		kfree = _halrf_get_kfree_tssi_offset_8822e(dm);
	}
